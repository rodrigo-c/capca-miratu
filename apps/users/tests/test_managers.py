...
class TestUserManager:
    ...
    def test_create_superuser(self):
        user_kwargs = {"email": "admin@example.com", "password": "something-r@nd0m!"}
        with pytest.raises(ValueError):
            User.objects.create_superuser(**{**user_kwargs, "is_staff": False})
        with pytest.raises(ValueError):
            User.objects.create_superuser(**{**user_kwargs, "is_superuser": False})
